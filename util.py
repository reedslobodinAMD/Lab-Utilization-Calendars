...
def event_lists_add(event_lists, sut_name, event_dict):
    sut_name = sut_name.split('.')[0]
    if sut_name in event_lists.keys():
        event_lists[sut_name].append(event_dict)
    else:
        event_lists[sut_name] = [event_dict]
